...
from .pdm_array_representation import array_to_states_se2
from .sledge_vector_feature import SledgeVectorElement
...
def compute_line_features(
    ...
    :return: raw sledge vector element for feature caching.
    """
    interpolatable_paths = get_edge_graph(ego_state, map_api, radius)   # Obtain a continuous path.
    return compute_path_features(interpolatable_paths, pose_interval)   # Generate position points along the path at the specified sampling interval.
