...
class Transformer(nn.Module):
    ...
    def forward(
        ...
        memory = self.encoder(src, pos_embed=pos_embed) # 就是个自回归
        hs = self.decoder(tgt, memory, pos_embed=pos_embed, query_pos=query_embed, memory_mask=memory_mask) # tgt先自回归，然后tgt做Q，memory做KV
        return hs
