...
from src.simulation.autoregressive_simulation import AutoregressiveSimulation
...
def build_simulations(
    ...
    scenarios = scenario_filter.get_scenarios() # 也是得到：nuplan-devkit/nuplan/planning/scenario_builder/nuplan_db/nuplan_scenario.py
    ...
    for scenario in scenarios:
        ...
        if pre_built_planners is None:
            ...
            planners = build_planners(cfg.planner, scenario)    # 构建plantf模型
        else:
        ...
        for planner in planners:
            ...
            simulation = AutoregressiveSimulation(
